	...
	return (
		<div className="flex gap-8 items-center bg-light-gray w-full p-6">
			...
			<section className="flex flex-col bg-white p-8 rounded-xl lg:w-2/3">
				<div className="mb-28">
					<h5 className="text-2xl font-bold leading-9 text-dark-gray">Customize your links</h5>
				...
				<div className="flex flex-col justify-center items-center gap-6">
					...
					<h6 className="text-2xl font-bold leading-9 text-dark-gray">Let’s get you started</h6>
