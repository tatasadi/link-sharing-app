...
export default function Create() {
	return (
		<section className="bg-white p-8 rounded-xl">
			...
			<div className="mb-8">
				<h4 className="text-2xl font-bold leading-9 text-dark-gray">Create account</h4>
				<p className="text-body-m text-gray">Let’s get you started sharing your links!</p>
			</div>
			<div className="mb-4">
				...
				<div className="flex relative mb-4">
					...
					<Image src={ph_envelope} className="absolute top-3 left-2" alt="icon" />
				</div>
				<label className="text-body-s text-dark-gray">Create password</label>
				<div className="flex relative mb-4">
					<Input
						type="password"
					...
					/>
					<Image src={ph_lock} className="absolute top-3 left-2" alt="icon" />
				</div>
				<label className="text-body-s text-dark-gray">Confirm password</label>
			...
			<p className="text-body-s text-gray">Password must contain at least 8 characters</p>
			<Button className="w-full mt-4">Create new account</Button>
			<div className="md:flex gap-2 mt-8 items-center justify-center">
				<p className="text-center text-gray text-body-m">Already have an account?</p>
