	...
	return (
		<div className="flex gap-8 justify-between items-center bg-white">
			...
			<section className="flex flex-col gap-4 p-6 bg-white rounded-xl">
				<div>
					<h2 className="text-2xl font-bold leading-9 text-dark-gray">Profile Details</h2>
				...
				<div className="bg-light-gray rounded-xl p-5 mt-4 md:flex md:items-center md:gap-4">
					<h3 className="text-body-m text-gray md:w-1/2">Profile picture</h3>
					<div className="bg-light-purple rounded-xl flex flex-col justify-center items-center w-[12rem] md:w-1/2 h-[12rem] my-8">
						...
						<a href="#" aria-label="+ Upload Image" className="text-heading-s text-purple">
							+ Upload Image
						</a>
					</div>
