	...
	return (
		<div className="flex flex-col items-center mx-auto gap-4 p-4 md:bg-purple md:h-[22.31rem] rounded-b-[2rem]">
			...
			<div className="flex flex-col justify-center items-center gap-4 md:bg-white md:rounded-3xl md:py-12 px-14 md:mt-10">
				...
				<PreviewLinkItem color="#1A1A1A" text="GitHub" icon="/teenyicons_github-solid.svg" />
				<PreviewLinkItem color="#EE3939" text="YouTube" icon="/ri_youtube-fill.svg" />
				<PreviewLinkItem color="#2D68FF" text="LinkedIn" icon="/mdi_linkedin.svg" />
				<PreviewLinkItem color="#333333" text="Dev.to" icon="/skill-icons_devto-dark.svg" />
				<PreviewLinkItem color="#8A1A50" text="Codewars" icon="/cib_codewars.svg" />
				<PreviewLinkItem color="#302267" text="freeCodeCamp" icon="/ri_codepen-line.svg" />
			</div>
		</div>
	)
}
