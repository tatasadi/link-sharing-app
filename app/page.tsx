	...
	return (
		<main className="flex flex-col items-center mx-auto gap-4 p-4 md:bg-royal-violet md:h-[22.31rem] rounded-b-[2rem]">
			...
			<div className="flex flex-col justify-center items-center gap-4 md:bg-white md:rounded-3xl md:py-12 px-14 md:mt-10">
				...
				<p className="text-heading-s text-stone-gray">ben@example.com</p>
				<Card color="#1A1A1A" text="GitHub" icon="/teenyicons_github-solid.svg" />
				<Card color="#EE3939" text="YouTube" icon="/ri_youtube-fill.svg" />
				<Card color="#2D68FF" text="LinkedIn" icon="/mdi_linkedin.svg" />
				<Card color="#333333" text="Dev.to" icon="/skill-icons_devto-dark.svg" />
				<Card color="#8A1A50" text="Codewars" icon="/cib_codewars.svg" />
				<Card color="#302267" text="freeCodeCamp" icon="/ri_codepen-line.svg" />
			</div>
			*/ profile /*
			<div className="flex gap-5 justify-center items-center">
				...
				<section className="flex flex-col gap-4 p-6 bg-white rounded-xl">
					<div>
						<h2 className="text-2xl font-bold leading-9 text-pure-gray">Profile Details</h2>
					...
					<div className="bg-pure-snow rounded-xl p-5 mt-4 md:flex md:items-center md:gap-4">
						<h3 className="text-body-m text-stone-gray md:w-1/2">Profile picture</h3>
						<div className="bg-soft-lilac rounded-xl flex flex-col justify-center items-center w-[12rem] md:w-1/2 h-[12rem] my-8">
							...
							<a href="#" aria-label="+ Upload Image" className="text-heading-s text-royal-violet">
								+ Upload Image
							</a>
						</div>
					...
					<Button className="w-full mb-8 md:w-[6rem] md:ml-auto">Save</Button>
				</section>
			</div>
			*/ Create Account /*
			<section className="bg-white p-8 rounded-xl">
				...
				<div className="mb-8">
					<h4 className="text-2xl font-bold leading-9 text-pure-gray">Create account</h4>
					<p className="text-body-m text-stone-gray">Let’s get you started sharing your links!</p>
				</div>
				<div className="mb-4">
					...
					<label className="text-body-s text-pure-gray">Create password</label>
					<div className="flex relative mb-4">
						<Input
							type="password"
					...
					<label className="text-body-s text-pure-gray">Confirm password</label>
				...
				<p className="text-body-s text-stone-gray">Password must contain at least 8 characters</p>
				<Button className="w-full mt-4">Create new account</Button>
				<div className="md:flex gap-2 mt-8 items-center justify-center">
					<p className="text-center text-stone-gray text-body-m">Already have an account?</p>
					<p className="text-center text-royal-violet text-body-m">Login</p>
				</div>
			</section>
			*/ Empty /*
			<section className="bg-white p-8 rounded-xl">
				<div className="mb-28">
					<h5 className="text-2xl font-bold leading-9 text-pure-gray">Customize your links</h5>
				...
				<div className="flex flex-col justify-center items-center gap-6">
					...
					<h6 className="text-2xl font-bold leading-9 text-pure-gray">Let’s get you started</h6>
				...
				<div className="w-full h-[.15rem] bg-dark-gray"></div>
				<Button className="mt-4 opacity-25 w-full md:w-[6rem] md:ml-auto">Save</Button>
			</section>
			*/ Added One Link /*
			<section className="bg-white p-8 rounded-xl">
				<div className="mb-28">
					...
					<Select>
						...
						<SelectContent>
							<SelectItem value="light">
								<img src="/teenyicons_github-solid.svg" className="bg-stone-gray" />
								GitHub
							</SelectItem>
				...
				<Button className="mt-4 w-full md:w-[6rem] md:ml-auto">Save</Button>
			</section>
		</main>
	)
}
